...
/*** XXX NEXT COMMENT SHOULD GO AWAY ***/
...
/*#include "gdtoa.h"*/
/* (not needed, guessed) #include "arith.h" */
#if alreadydone /* XXX clean */
...
/* XXX needed to get malloc() and free() ! would be overridden ?! */
#include "stdlib.h"
//#include "string.h"
...
FPI fpi_binary32 = { 24, 1-127-24+1,  254-127-24+1, 1, SI };
FPI fpi_binary64 = { 53, 1-1023-53+1, 2046-1023-53+1, 1, SI };
FPI fpi_binaryx80 = { 64, 1-16383-64+1, 32766-16383-64+1, 1, SI };
#ifndef notyet
FPI fpi_binary128 = { 113, 1-16383-113+1, 32766-16383-113+1, 1, SI };
#endif
